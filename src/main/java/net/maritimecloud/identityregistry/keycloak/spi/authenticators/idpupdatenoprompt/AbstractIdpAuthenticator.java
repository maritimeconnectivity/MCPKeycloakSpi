...
public abstract class AbstractIdpAuthenticator implements Authenticator {
    ...
    // Copied from org.keycloak.services.messages.Messages
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        if (!brokerContext.getIdpConfig().isEnabled()) {
            sendFailureChallenge(context, Errors.IDENTITY_PROVIDER_ERROR, IDENTITY_PROVIDER_UNEXPECTED_ERROR, AuthenticationFlowError.IDENTITY_PROVIDER_ERROR);
        }
